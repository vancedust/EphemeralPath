// This function creates a new tab with dsicord link
function discord() {
...
// This function goes to home page
function home_link() {
    window.open("index.html", "_self");
}

// This function goes to figure builder
function fig_link() {
...
function ruledwn() {
    window.open("ephemeral path rules of play v0.25.pdf");
}

// This function downloads rules
function abdwn() {
    window.open("ephemeral path ability guide w0.35.pdf");
}
