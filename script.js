...
function abdrop(){
    ...
    var optionsm = ["Select Ability",
		    ...
		    "DD1; pnts; 2; Defend - Reduce attack damage by [D4] if within defending figure's range",
		    "DD2; pnts; 8; Defend - Reduce attack damage by [D12] from any range",
    ...
    var optionmd = ["Select Ability",
		    ...
		    "TD1; Pnts; 2;Defend- Reduce attack damage by [D4] if within defending figure’s range",
		    "TD2; Pnts; 8;Defend- Reduce attack damage by [D12] from any range",
